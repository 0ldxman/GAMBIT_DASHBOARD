...
- **Описания страницами**: у типа несколько страниц, каждая уходит отдельным эмбедом — так статы
  длиннее лимита эмбеда всё-таки помещаются. Отдельной сущности можно включить **особое описание**,
