...
SAMPLE_EXTRAS: dict[str, Any] = {
    ...
    "лидер": "Игрок",
    "родители": [{"название": "Организация", "тип": "член организации", "id": 0}],
    "дети": [{"название": "Провинция", "тип": "состав", "id": 0}],
    "связи": {
        "союзник": [{"название": "Соседняя страна", "тип": "союзник", "id": 0}],
        "состав": [{"название": "Провинция", "тип": "состав", "id": 0}],
    },
    "тип": "Тип сущности",
}
